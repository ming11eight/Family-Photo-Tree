...
from inception_resnet_v1 import InceptionResnetV1, load_weights
...
class FaceNetModel(nn.Module):
    def __init__(self, pretrained=False):
        ...
        self.model = resnet50(pretrained)  # train_작업중
